...
if __name__ == '__main__':
    ...
    left_H = []
    right_H = []
    cv2.imwrite("registration_output/img{}.jpg".format(0), img)
    cv2.imwrite("registration_output/mask{}.jpg".format(0), mask)
    for i in range(1, len(Images)//2+1):
        ...
        try:
            ...
            cv2.imwrite("registration_output/mask{}.jpg".format(N//2+i), mask)
