...
image_set = "night"
image_id = input("enter which image: ")

inputImagePath = "../data/{}/{}/".format(image_set, image_id)
expectedImagePath = "../data/{}/{}/".format(image_set, image_id)
outputFolderPath = "output_{}/{}/".format(image_set, image_id)

inputImage = cv2.imread(os.path.join(inputImagePath, "night_mode_off.jpg") )
expectedImage = cv2.imread(os.path.join(inputImagePath, "night_mode_on.jpg") )
