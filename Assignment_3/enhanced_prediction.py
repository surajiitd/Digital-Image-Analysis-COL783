...
if __name__ == "__main__":
	...
	for i in range(len(images)):
		...
		orig = main_SR(orig)
		cv2.imwrite(images[i][:-4]+"_{}.png".format(distance_metric),orig)
		rotated90 = main_SR(rotated90)
		cv2.imwrite(images[i][:-4]+"_rotated90_{}.png".format(distance_metric),rotated90)
		rotated180 = main_SR(rotated180)
		cv2.imwrite(images[i][:-4]+"_rotated180_{}.png".format(distance_metric),rotated180)
		rotated270 = main_SR(rotated270)
		cv2.imwrite(images[i][:-4]+"_rotated270_{}.png".format(distance_metric),rotated270)

		flipped = main_SR(flipped)
		cv2.imwrite(images[i][:-4]+"_flipped_{}.png".format(distance_metric),flipped)
		rotated90_flipped = main_SR(rotated90_flipped)
		cv2.imwrite(images[i][:-4]+"_rotated90_flipped_{}.png".format(distance_metric),rotated90_flipped)
		rotated180_flipped = main_SR(rotated180_flipped)
		cv2.imwrite(images[i][:-4]+"_rotated180_flipped_{}.png".format(distance_metric),rotated180_flipped)
		rotated270_flipped = main_SR(rotated270_flipped)
		cv2.imwrite(images[i][:-4]+"_rotated270_flipped_{}.png".format(distance_metric),rotated270_flipped)
